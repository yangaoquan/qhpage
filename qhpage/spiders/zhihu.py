...
from qhpage.items import ZhihuPeopleItem
...
class ZhihuSpider(CrawlSpider):
    ...
    rules = [
        Rule(LinkExtractor(allow=("/people/[^/]+/followees$")), callback='parse_followees'),
        Rule(LinkExtractor(allow=("/people/[^/]+/followers$", )), callback='parse_followers'),
        Rule(LinkExtractor(allow=("/people/[^/]+$", )), callback='parse_people_with_rules', follow=True),
    ]
    ...
    def parse_people_with_rules(self, response):
        ...
        logging.info('Parsed '+response.url) # +' to '+str(item))
        return item
